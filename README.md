...
- **Dynamic Campaign Generator & Progression:** Custom Unity Editor tooling (`CampaignGenerator.cs`) capable of procedurally generating a 500-level Campaign with a smooth difficulty curve scaling grid size and gem counts. The game integrates seamlessly with `PlayerPrefs` to automatically save your campaign progress—if you win level 4, it saves, and you will resume at level 5 next time you boot up the game.
